...
const _routes = [
  {
    ...
    component: () => import('./1-dc1fa41c.mjs').then((m) => m.default || m)
  },
  {
    ...
    component: () => import('./index-b9786887.mjs').then((m) => m.default || m)
  }
];
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = defineAsyncComponent(() => import('./error-component-d87d7dff.mjs').then((r) => r.default || r));
